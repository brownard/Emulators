...
namespace Emulators
{
    class DB_Updater
    {
        ...
        void loadUpdates()
        {
            ...
            //    DB.Instance.Execute("COMMIT");
            //    SQLData currentPrefixes = DB.Instance.Execute("SELECT uid, goodmerge_pref1, goodmerge_pref2, goodmerge_pref3 FROM emuprofiletemp");
            ...
            //    SQLData enableGoodmerge = DB.Instance.Execute("SELECT uid, enable_goodmerge FROM emustemp");
